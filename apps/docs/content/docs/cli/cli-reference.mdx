...
<Command
	...
	options={[
		...
		{ flag: "--prompt-arg <token>", description: "Arg inserted before the prompt. Repeatable, and may itself be a flag (`--prompt-arg -p`)." },
...
<Command
	...
	options={[
		...
		{ flag: "--prompt-arg <token>", description: "Replaces the prompt args. Repeatable, and may itself be a flag." },
